...
!function (l) {
    ...
    function e() {
        this.$body = l("body"),
            ...
            this.$toggler_event = l("#toggler_event"),
            this.$alphabetical = l("#alphabetical"),
    ...
    e.prototype.onEventClick = function (e) {
        ...
        let status = this.$selectedEvent._def.extendedProps.status;

        if (status === 3) {
            this.$btnCancelEvent.hide(),
                this.$btnEditEvent.hide(),
                this.$btnNewEvent.hide(),
        ...
        this.$modalTitle.text("Edit Booking"),
            ...
            l("#event-id").val(this.$selectedEvent._def.publicId),
            l("#event-title").val(this.$selectedEvent.title),
            l("#event-start").val(this.$selectedEvent.start),
            l("#event-name").val(this.$selectedEvent._def.extendedProps.first_name),
            l("#event-surname").val(this.$selectedEvent._def.extendedProps.surname),
            l("#event-email").val(this.$selectedEvent._def.extendedProps.email),
            l("#event-cell_number").val(this.$selectedEvent._def.extendedProps.cell_number),
            l("#event-note").val(this.$selectedEvent._def.extendedProps.Notes),
            l("#event-patient").val(this.$selectedEvent._def.extendedProps.patient_id),
            l("#event-category").val(this.$selectedEvent.classNames[0])

        // console.log(this.$selectedEvent._def.extendedProps.surname)
        ...
        this.$formEvent[0].reset(),
            ...
            this.$btnNoshowEvent.hide(),
            this.$btnCheck_outEvent.hide(),
            this.$toggler_event.hide(),
            this.$alphabetical.hide(),
        ...
        e.prototype.init = async function () {
            ...
            a.$calendarObj = new FullCalendar.Calendar(a.$calendar[0], {
                ...
                buttonText: {
                    ...
                    prev: "Prev",
                    next: "Next"
                    //timeGridWeek || dayGridMonth ||dayGridWeek || listWeek
                },
                ...
                header: {
                    left: "prevYear,prev,next,nextYear,today,datepicker",
                    center: "title",
                                    ...
                                    if (data === 1) {
                                        ...
                                        $.ajax({
                                            ...
                                            error: function (error) {
                                                ...
                                                localStorage.setItem("errorMs", error.status);
                ...
                const n = {
                    ...
                    className: l("#event-category").val(),
                    classPatient: l("#event-patient").val(),
                    Datetoggler: l("#switch_right").val(),
                    date_time_start: l("#datetime-datepicker").val(),
                    date_time_end: l("#time-datepicker").val(),
                    Datetoggler: l("input:radio[name=switch_2]:checked").val(),
