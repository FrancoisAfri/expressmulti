<div class="modal fade" id="edit-new-ribbon-modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="edit-ribbon-form">
                ...
                <div class="modal-header bg-light">
                    <h4 class="modal-title" id="myCenterModalLabel">Edit  Ribbon</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-right">
                        ...
                        <button type="button" id="edit-ribbon" class="btn btn-success waves-effect waves-light">
                             Update
                        </button>
                    </div>
                </div>
