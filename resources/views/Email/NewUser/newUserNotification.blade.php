                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            <a href="#"><img style="height: 50px" src="{{ $mailData['logo'] }}" alt="logo"></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding: 50px 50px 25px 50px;">
                            <h2 style="font-size: 22px; color: #6576ff; font-weight: 600; margin: 0;">Confirm Your E-Mail Address</h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 30px 20px">
                            <p style="margin-bottom: 10px;">Hi {{ $mailData['name'] }},</p>
                            <p style="margin-bottom: 10px;"> You are receiving this email because you have registered
                                on our site.</p><br>
                            <p style="margin-bottom: 10px;">Click the link below to active your account.</p><br>
                            <p style="margin-bottom: 25px;">This link will expire in 48 hours and can only be used once.</p>
                            <a href="{{ $mailData['url'] }}" style="background-color:#6576ff;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:600;line-height:44px;text-align:center;text-decoration:none;text-transform: uppercase; padding: 0 30px">Verify Email</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 30px">
                            ...
                            <a href="{{$mailData['url']}}" style="color: #6576ff; text-decoration:none;word-break: break-all;">{{ $mailData['url'] }}</a>
                        </td>
                    </tr>
                    <tr>
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding:25px 20px 0;">
                            <p style="font-size: 13px;">Copyright © 2020 {{ $mailData['company_name'] }}. All rights reserved. <br> <a style="color: #6576ff; text-decoration:none;" href="$mailData['support']}}">{{ $mailData['company_name'] }}</a>.</p>
...
{{--                            </ul>--}}
                            <p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="{{ $mailData['support']}}">{{ $mailData['company_name'] }}</a>. To update your emails preferences <a style="color: #6576ff; text-decoration:none;" href="#">click here</a>.</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
