                ...
                <table style="width:100%;max-width:620px;margin:0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom:25px">
                            ...
                            {{--                            <p style="font-size: 14px; color: #6576ff; padding-top: 12px;">Conceptual Base Modern--}}
                            {{--                                Dashboard Theme</p>--}}
                        </td>
                    </tr>
                    </tbody>
                ...
                <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                    ...
                    <tr>
                        <td style="text-align:center;padding: 0 30px 20px">
                            ...
                            <p style="margin-bottom: 25px;">You are receiving this email because we received a password reset request for your account,</p>
                    ...
                    <tr>
                        <td style="padding: 0 30px">
                            <h4 style="text-align: center;font-size: 15px; color: #000000; font-weight: 600; margin: 0; text-transform: uppercase; margin-bottom: 10px">
                                or</h4>
                            <p style="margin-bottom: 10px;">If the button above does not work, paste this link into your
                                web browser:</p>
                            <a href="{{$mailData['url']}}"
                               style="color: #6576ff; text-decoration:none;word-break: break-all;">{{ $mailData['url'] }}</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;padding: 20px 30px 40px">
                            ...
                            <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">This is an
                                ...
                                please contact us at {{ $mailData['support'] }}</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
