...
<head>
    ...
    <title>{{ $mailData['company_name'] }} - Client Communication</title>
                    ...
                    <tr>
                        <td valign="top" class="wrap-cell" style="padding-top:30px; padding-bottom:30px;">
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                <tr>
                                    <td class="text-center" height="60" valign="top" class="header-cell" >
                                        <img width="196" height="60" src="{{ $mailData['logo'] }}" alt="logo">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
                                        ...
                                        <h4></h4>
                                        <i></i><br>
                                        Please do not reply to this email. If you have received this email by mistake, please contact our support team on <a href="mailto:{{ $mailData['support'] }}">{{ $mailData['support'] }}</a>.<br>
