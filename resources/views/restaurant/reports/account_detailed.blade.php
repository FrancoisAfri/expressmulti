                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table mt-4 table-centered">
                                    ...
                                    @foreach($detailedTransactions as $detailed)
                                        <tr>
                                            <td> {{ $detailed->patient->full_name ?? '' }}</td>
                                            <td> {{ $detailed->account->account_number ?? ''}}</td>
                                            <td> {{ $detailed->icd10_code ?? '' }}</td>
                                            <td> {{ $detailed->Description ?? ''  }}</td>
                                            <td> {{ $detailed->quantity ?? '' }}</td>
                                            <td> {{  $detailed->status ?? ''  }}</td>
                                            <td> {{  $detailed->doc_no ?? ''  }}</td>
                                            <td>   R {{ number_format($detailed->price , 2, ',', '.')  }} </td>
...
{{--                            </button>--}}
                            ...
                            <a href="report/transaction_detailed"
