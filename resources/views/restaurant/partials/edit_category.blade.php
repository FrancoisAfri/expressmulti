    ...
    <div class="modal-dialog modal-dialog-scrollable  modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <form class="needs-validation" novalidate method="Post" name="edit-category-form">
                    {{ csrf_field() }}
                    @if ($errors->any())
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="form-group text-center">
                                <button type="button" id="edit-category" class="btn btn-success waves-effect waves-light">
                                    Save
                                </button>
                            </div>
                        </div>
