...
<div id="add-new-package-modal" class="modal fade" tabindex="-1" role="dialog"
     aria-labelledby="scrollableModalTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable  modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <form class="needs-validation" novalidate method="Post" name="add-package-form">
                    {{ csrf_field() }}
                    @if ($errors->any())
                    ...
                    <div class="modal-header bg-light">
                        <h4 class="modal-title" id="myCenterModalLabel">Add Package</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="form-group text-center">
                                <button type="button" id="add-package" class="btn btn-success waves-effect waves-light">
                                    Save
                                </button>
                            </div>
                        </div>
