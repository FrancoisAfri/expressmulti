...
@section('content')
    @section('content_data')
        ...
        <div class="container-fluid">
            <form method="Post" action="{{ route('patient_details.update', $patient->id) }}"
                                    ...
                                    <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100"
                                        ...
                                        @foreach ($dependencies as $key => $module)
                                            ...
                                            <span>
                                                ...
                                                <td>
                                            <span>
                                                 {{ $module->dependency_date_of_birth ?? ''}}
                                            </span>
                                                </td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="medical_aid_scheme_name"
                                                       value="{{ $medical->medical_aid_scheme_name ?? ''}}"
                                                       name="medical_aid_scheme_name" placeholder="Enter scheme name">
                                            </div>
                                        </div>
