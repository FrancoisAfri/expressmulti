        ...
        <div class="container-fluid">
            <form class="needs-validation" novalidate method="Post"
                ...
                <div class="text-center mb-3">
                    ...
                    <button type="button"  onclick="approveClient('{{$client->uuid}}')"  class="btn w-sm btn-success waves-effect waves-light">Approve
                    </button>
                    <button type="button" onclick="declineClient('{{$client->uuid}}')" class="btn w-sm btn-danger waves-effect waves-light">Reject
                    </button>
                </div>
				<br>
				<br>
